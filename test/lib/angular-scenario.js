...
(function() {
    ...
    angular.mock.TzDate = function(offset, timestamp) {
        ...
        var localOffset = new Date(timestamp)
            .getTimezoneOffset();
    ...
    function serialize(object) {
        ...
        if (angular.isElement(object)) {
            ...
            angular.forEach(object, function(element) {
                out.append(angular.element(element)
                    .clone());
            });
            out = out.html();
...
function createHttpBackendMock($delegate, $browser) {
    ...
    function $httpBackend(method, url, data, callback, headers) {
        ...
        if (expectation && expectation.match(method, url)) {
            if (!expectation.matchData(data)) throw Error('Expected ' + expectation + ' with different data\n' + 'EXPECTED: ' + prettyPrint(expectation.data) + '\nGOT: ' + data);

            if (!expectation.matchHeaders(headers)) throw Error('Expected ' + expectation + ' with different headers\n' + 'EXPECTED: ' + prettyPrint(expectation.headers) + '\nGOT: ' + prettyPrint(headers));
